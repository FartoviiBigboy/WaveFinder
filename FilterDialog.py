...
class FilterDialog(QDialog):
    def __init__(self, parent) -> None:
        ...
        self.button_group: QButtonGroup = self.__initialize_button_group()
        self.type_by_button: dict[QRadioButton, str] = self.__initialize_type_by_buttons()
        self.filter_type: str = "lowpass"
    ...
    def _on_radio_button_clicked(self, button) -> None:
    ...
    def __change_input_view(self, low_label, visibility) -> None:
    ...
    def __initialize_button_group(self) -> QButtonGroup:
    ...
    def __initialize_type_by_buttons(self) -> dict[QRadioButton, str]:
        return {
    ...
    def __initialize_validation(self) -> None:
        double_val: QDoubleValidator = QDoubleValidator(0.0, 100.0, 2)
        double_val.setLocale(QtCore.QLocale("en_US"))
        int_val: QIntValidator = QIntValidator(0, 100)
